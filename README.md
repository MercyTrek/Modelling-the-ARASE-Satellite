# Table of Contents
- [Overview](#overview)
- [Project 1: Modelling the ARASE Satellite](#project-1-modelling-the-arase-satellite)
# Overview
The purpose of this repository is to show the projects that I have done throughout my studies. For each project, you will find a short description and a demo video. If you have any further questions, please do not hesitate to reach out to me.
<details>
  <summary><strong>Project 1: Modelling the ARASE Satellite</strong></summary>
  
## Project 1: Modelling the ARASE Satellite
